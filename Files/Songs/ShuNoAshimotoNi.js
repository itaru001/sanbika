...
function Jissou(uta) {
	...
	chord2.innerHTML = uta.getSharpA();

	var chord3 = document.getElementById("chord3");
	chord3.innerHTML = uta.getSharpG();
	...
	chord7.innerHTML = uta.getSharpE() + "m";

	var chord8 = document.getElementById("chord8");
	chord8.innerHTML = uta.getSharpA();
	...
	chord17.innerHTML = uta.getSharpD();

	var chord18 = document.getElementById("chord18");
	chord18.innerHTML = uta.getSharpA();
